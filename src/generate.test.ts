...
describe('generate', () => {
    ...
    const JS_EVAL_SETTINGS = { sampleRate: 44100, channelCount: 2, engineOutputVariableNames: ['ENGINE_OUTPUT1', 'ENGINE_OUTPUT2'] }
    ...
    it('should generate the full function as a string', async () => {
        ...
        assert.strictEqual(normalizeCode(dspFunction), normalizeCode(`
    ...
    describe('generateSetupAndLoop', () => {
        ...
        it('should generate the setup / loop function', async () => {
            ...
            const {setup, loop} = await generateSetupAndLoop(graph, registry, JS_EVAL_SETTINGS)
