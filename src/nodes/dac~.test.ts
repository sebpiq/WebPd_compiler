...
import { buildEngineOutput, getEngine } from './test-helpers'
...
describe('dac~', () => {
    ...
    const generateFrames = async(target: CompilerTarget, args: any) => {
        ...
        const engineOutput = buildEngineOutput(Float32Array, channelCount, blockSize)
