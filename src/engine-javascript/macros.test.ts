...
describe('macros', () => {
    ...
    describe('isMessageMatching', () => {
        it('should generate condition for types', () => {
            ...
            assert.strictEqual(
                code,
                '(myMessage.length === 2 && typeof myMessage[0] === "string" && typeof myMessage[1] === "number")'
            )
        })
        ...
        it('should generate condition for values', () => {
            ...
            assert.strictEqual(
                code,
                '(myMessage.length === 2 && myMessage[0] === "blabla" && myMessage[1] === 123.5)'
            )
        })
        ...
        it('should generate condition for types and values', () => {
            ...
            assert.strictEqual(
                code,
                '(myMessage.length === 2 && typeof myMessage[0] === "number" && myMessage[1] === "bla")'
            )
        })
    })
})
