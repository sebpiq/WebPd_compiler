...
export interface EngineCoreRawModule {
...
export type EngineCoreWithDependenciesRawModule = CoreRawModule &
    MsgRawModule &
    EngineCoreRawModule

interface EngineCoreBindings {
...
export const updateWasmInOuts = (
    rawModule: EngineCoreWithDependenciesRawModule,
...
export const createEngineCoreBindings = (
    rawModule: EngineCoreWithDependenciesRawModule,
    engineData: EngineData
): Bindings<EngineCoreBindings> => {
    return {
        configure: {
            type: 'proxy',
...
export const createOutletListenersBindings = (
    _: EngineCoreWithDependenciesRawModule,
    engineData: EngineData
...
export const outletListenersImports = (
    forwardReferences: ForwardReferences<EngineCoreWithDependenciesRawModule>,
