...
export interface fs_WasmExports extends tarray_WasmExports {
    fs_requestReadSoundFile: (id: number, url: StringPointer, info: InternalPointer) => void
    fs_requestReadSoundStream: (id: number, url: StringPointer, info: InternalPointer) => void
    fs_requestWriteSoundFile: (id: number, url: StringPointer, sound: InternalPointer, info: InternalPointer) => void
