        ...
        describe('read / write mode', () => {
            ...
            it.each(TEST_PARAMETERS)(
                ...
                async ({ bitDepth }) => {
                    ...
                    bindings.buf_writeSample(soundBuffer, 22)
                    bindings.buf_writeSample(soundBuffer, 33)
                    assert.doesNotThrow(() => bindings.buf_readSample(soundBuffer, 4))
                    assert.doesNotThrow(() => bindings.buf_readSample(soundBuffer, 1000))
                    assert.doesNotThrow(() => bindings.buf_readSample(soundBuffer, -1345))
                }
            )
        })
