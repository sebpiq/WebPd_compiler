...
describe('compileToAssemblyscript', () => {
    it('should have all expected wasm exports when compiled', async () => {
        ...
        const expectedExports: AssemblyScriptWasmExports &
            ...
            farray_get: () => undefined,
            farray_set: () => undefined,
            farray_create: () => undefined,
            farray_createListOfArrays: () => undefined,
            farray_pushToListOfArrays: () => undefined,
            farray_getListOfArraysLength: () => undefined,
            farray_getListOfArraysElem: () => undefined,
